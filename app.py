...
def get_building_with_most_waste(year):
    # Filter data for the specified year
    year_data = data[data["Year"] == year]
    
    # Calculate waste produced by each building
    building_waste = year_data.groupby("Building")["Total"].sum()
    
    # Find the building with the most waste
    building_with_most_waste = building_waste.idxmax()
    
    # Get the amount of waste generated by the building
    waste_generated = building_waste[building_with_most_waste]
    
    return building_with_most_waste, waste_generated

# Row A
st.markdown('### Metrics')
year_with_max_waste, total_waste_max_year = getMostWasteYearandWaste()
building_with_most_waste, waste_generated = get_building_with_most_waste(year_with_max_waste)
